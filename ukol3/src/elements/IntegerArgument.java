...
public class IntegerArgument extends Argument {
	 ...
	 */
	public IntegerArgument(String name, int defaultValue) throws IllegalArgumentException {
		super(name);
	 ...
	 * @throws IllegalArgumentException
	 */
	public IntegerArgument(String name, int defaultValue, int minValue, int maxValue) throws IllegalArgumentException {
		super(name);
		setDefaultValue(defaultValue);
	 ...
	 * @throws IllegalArgumentException
	 */
	public void setDefaultValue(int defaultValue) throws IllegalArgumentException {
	...
	public void setMaxValue(int maxValue) throws IllegalArgumentException {
		if (maxValue < this.minValue) {
			throw new IllegalArgumentException("Maximum value can't be lesser than minimum value.");
		}
	 ...
	 * @throws IllegalArgumentException
	 */
	protected void validateDefaultValue(int defaultValue, int minValue, int maxValue) throws IllegalArgumentException {
		if (defaultValue < minValue) {
			throw new IllegalArgumentException("Default value can't be lesser than minimum value.");
		}
		
		if (defaultValue > maxValue) {
			throw new IllegalArgumentException("Default value can't be greater than maximum value.");
		}
	}	
