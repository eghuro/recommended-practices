...
public class EnumeratedArgument extends Argument {
	 ...
	 */
	public EnumeratedArgument(String name, Set<String> values) throws IllegalArgumentException {
		super(name);
		addValues(values);
	}
	 ...
	 * @throws IllegalArgumentException
	 */
	public EnumeratedArgument(String name, Set<String> values, String defaultValue) throws IllegalArgumentException {
		super(name);
		addValues(values);
	...
	private void validateValue(String value) throws IllegalArgumentException {
    	if (value == null || value.length() == 0) {
    		throw new IllegalArgumentException("Enumerated value can't be empty.");
    	}
    	
    	if (!value.matches("^[A-Za-z0-9_]*[A-Za-z0-9][A-Za-z0-9_]*$")) {
    		throw new IllegalArgumentException("Invalid enumerated value - accepts letters, numbers and underscores.");
    	}
	...
	public void setDefaultValue(String defaultValue) throws IllegalArgumentException {
		...
		if (!this.values.contains(defaultValue)) {
			throw new IllegalArgumentException("Default value isn't in the list of values.");
		}
